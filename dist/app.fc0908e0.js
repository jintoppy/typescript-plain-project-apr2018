...
var searchInput = document.querySelector('#myfilter');
var renderList = function renderList(users) {
    ...
    users.forEach(function (user) {
        ...
        var loginCellTd = document.createElement('td');
        var idCellTd = document.createElement('td');
...
searchInput.addEventListener('keyup', function () {
    ...
    var filteredUsers = data_1.users.filter(function (user) {
        return user.login.includes(query);
    });
    renderList(filteredUsers);
});
renderList(data_1.users);
},{"./data":15}],19:[function(require,module,exports) {
...
//# sourceMappingURL=/app.fc0908e0.map